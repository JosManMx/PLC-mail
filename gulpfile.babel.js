...
// Set custom fonts url
const fontsURL = 'http://52.24.157.128/plc-mail-fonts/bunken-fonts.css';
...
function inliner(css) {
  ...
  var pipe = lazypipe()
    ...
    .pipe($.replace, '<!-- <custom-fonts> -->', `<link rel="stylesheet" type="text/css" href="${fontsURL}">`)
    .pipe($.htmlmin, {
